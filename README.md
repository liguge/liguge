...
2. [IDSN: A one-stage Interpretable and Differentiable STFT domain adaptation Network for traction motor of high-speed trains cross-machine diagnosis](https://doi.org/10.1016/j.ymssp.2023.110846)[![Citation Count](https://img.shields.io/badge/citations-61-blue)](https://example.com/link_to_your_paper)
...
3. :fire::trophy:[Interpretable Physics-informed Domain Adaptation Paradigm for Cross-machine Transfer Diagnosis](https://doi.org/10.1016/j.knosys.2024.111499)[![Citation Count](https://img.shields.io/badge/citations-82-blue)](https://example.com/link_to_your_paper)
...
7. **[Awesome large language model for Prognostics and health management（用于预测性维护与健康管理的大型语言模型）](https://github.com/liguge/Large-language-model-for-Prognostics-and-health-management)** ![Github stars](https://img.shields.io/github/stars/liguge/Large-language-model-for-Prognostics-and-health-management.svg)
...
1. :trophy:[Fault diagnosis for small samples based on attention mechanism](https://doi.org/10.1016/j.measurement.2021.110242) [![Citation Count](https://img.shields.io/badge/citations-249-blue)](https://example.com/link_to_your_paper)   
